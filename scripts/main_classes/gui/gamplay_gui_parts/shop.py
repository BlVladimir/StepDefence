        ...
        buttons_towers = {DirectButton(image=self.__create_texture('images2d/tower/common_foundation.png',
                          ...
                          DirectButton(image='images2d/tower/anty_invisibility_tower.png',
                                       ...
                                       frameColor=((0.5, 0.5, 0.5, 1),
                                                   (0.7, 0.7, 0.7, 1),
                                                   (0.3, 0.3, 0.3, 1))),
                          DirectButton(image=self.__create_texture('images2d/tower/cutter_foundation.png',
                                                                   'images2d/tower/cutter_gun.png'),
                                       parent=self.__shop_frame,
                                       scale=0.075,
                                       pos=Vec3(0, -0.2),
                                       command=lambda: EventBus.publish('buy_tower', 'cutter'),
                                       frameColor=((0.5, 0.5, 0.5, 1),
                                                   (0.7, 0.7, 0.7, 1),
                                                   (0.3, 0.3, 0.3, 1))),
                          DirectButton(image=self.__create_texture('images2d/tower/laser_foundation.png',
                                                                   'images2d/tower/laser_gun.png'),
                                       parent=self.__shop_frame,
                                       scale=0.075,
                                       pos=Vec3(0, -0.4),
                                       command=lambda: EventBus.publish('buy_tower', 'laser'),
                                       frameColor=((0.5, 0.5, 0.5, 1),
                                                   (0.7, 0.7, 0.7, 1),
                                                   (0.3, 0.3, 0.3, 1))),
