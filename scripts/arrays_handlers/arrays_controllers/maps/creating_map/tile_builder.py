...
class TilesPrototype(AbstractTilesBuilder):
    def __init__(self, maps_node:PandaNode, loader):
        ...
        self.__tiles = {'road':CopyingSprite3D('images2d/tile/for_enemies.png', super()._maps_node, super()._loader, 1, 'tile'),
                        'base':CopyingSprite3D('images2d/tile/common_building.png', super()._maps_node, super()._loader, 1, 'tile'),
                        'basic':CopyingSprite3D('images2d/tile/common_building.png', super()._maps_node, super()._loader, 1, 'tile'),
                        'increase_damage':CopyingSprite3D('images2d/tile/damage_up.png', super()._maps_node, super()._loader, 1, 'tile'),
                        'increase_radius':CopyingSprite3D('images2d/tile/radius_up.png', super()._maps_node, super()._loader, 1, 'tile'),
                        'piercing_armor':CopyingSprite3D('images2d/tile/piercing_armor.png', super()._maps_node, super()._loader, 1, 'tile'),
                        'poison':CopyingSprite3D('images2d/tile/poison_up.png', super()._maps_node, super()._loader, 1, 'tile'),
                        'additional_money':CopyingSprite3D('images2d/tile/money_up.png', super()._maps_node, super()._loader, 1, 'tile')}
