...
class TowersConfig:
    ...
    class TowerConfig:
        def __init__(self):
            self.__products = {
                'basic_damage': dict(basic_damage=2, cost=3, radius=Radius(1), improve_cost_array=(4, 6), additional_money=2),
        ...
        def get_gun_strategy(self, type_tower: str)->Optional[str]:
